...
export default function FilesUpload() {
  ...
  const fileSubmit = async (e) => {
    ...
    try {
      if (input.files.length > 0) {
        ...
        // Enviar la solicitud con la configuración del encabezado y las credenciales
        ...
        // Verificar si la carga de archivos fue exitosa
  ...
  return (
    <form
      onSubmit={fileSubmit}
      className="shadow-[0_8px_10px_1px_#00000026] relative flex flex-col gap-[25px] p-[25px] bg-[#E9ECEF] w-[400px] h-fit rounded-[25px] items-center"
      name="fileUpload"
      ref={dropRef}
    ...
    >
      ...
      <div
        className="w-[100px] h-[100px] flex items-center justify-center cursor-pointer bg-[#6AB547] rounded-full text-center shadow-button"
      ...
      <div className="flex justify-center relative w-full">
        <button
          className="enabled:shadow-button cursor-pointer disabled:cursor-default disabled:opacity-40 bg-[#00B4D8] text-white w-[135px] h-[50px] rounded-[25px]"
          type="submit"
          ref={buttonRef}
        >
          Subir
