        ...
        <menu className="flex flex-col text-[11px]">
          ...
          {files &&
            files.map((file) => {
              return (
                <li
                  className="grid [grid-template-columns:3fr_1.5fr_1fr_repeat(2,0.3fr)] px-[30px] gap-[15px] justify-center items-center h-[3lh] border-[#CED4DA] border-b-[1px] "
                  key={file._id}
                >
                  ...
                  <button
                    className="flex justify-center items-center rounded-full w-[35px] px-[6px] h-[35px] bg-[#00B4D8] gap-[5px] shadow-button"
      ...
      {Object.keys(pagination).length > 0 && (
        <div className="flex justify-between items-center gap-[15px] px-[30px]">
          ...
          <div className="flex gap-[15px]">
            <button
              className="h-[50px] w-[135px] bg-[#e9e9e9] rounded-[25px] enabled:shadow-[0_4px_3px_1px_#00000026] disabled:opacity-60"
              disabled={!pagination.hasPrevPage}
              onClick={() => getFiles(pagination.prevPage)}
            >
              Anterior
            </button>
            <button
              ...
              onClick={() => getFiles(pagination.nextPage)}
            >
              Siguiente
            </button>
          </div>
