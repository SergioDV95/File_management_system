   ...
   return (
      <section className='relative flex flex-col bg-blue_bg bg-no-repeat bg-fixed bg-cover w-screen h-screen px-[50px]' onClick={handleSectionClick}>
         <div className='flex justify-end items-center h-[10%]'>
            ...
            <dialog className='absolute mr-0 w-[60%] right-0 top-0 h-screen bg-[#F8F9FA] text-[12px] rounded-l-[25px] shadow-[-4px_1px_4px_1px_#00000026]' onClick={(e) => e.stopPropagation()} ref={dialogRef}>
               <FilesDisplay />
            </dialog>
         </div>
